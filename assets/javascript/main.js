...
invalidTextAlertBox.innerHTML = '<p>Texto inválido! Por favor, insira um texto somente com letras minúsculas e sem acentos.</p><button onclick="removeBoxAlert()">X</button>';
